<div class="bs-docs-section">
	...
	<div class="row">
	  <div class="col-lg-6">
		<div class="well">
		<?php 
		echo $this->Form->create('Carbrand', array('class' => 'bs-example form-horizontal')); 
		echo $this->Form->input('id');
		?>
		  <fieldset>
			  <legend><?php echo __('Edit Car Brand'); ?></legend>
			  <div class="form-group">
				<label for="inputName" class="col-lg-2 control-label">Dealer</label>
				<div class="col-lg-10">
