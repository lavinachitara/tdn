	  ...
	  <div class="col-lg-6">
		...
		?>
		  <fieldset>
			  ...
			  <div class="form-group">
				<label for="inputUserName" class="col-lg-2 control-label">Site</label>
				<div class="col-lg-10">
					<?php echo $this->Form->input('site', array('class' => 'form-control', 'placeholder' => 'Site Name', 'label' => false)); ?>
