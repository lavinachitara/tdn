...
class User extends AppModel {
    ...
    public function isUnique($params,$id="")
    {
        ...
        if($id != "")
            $params[$this->name.'.id != '] = $id;
        
        //$count = $this->find('count',array('conditions' => $params));
        //return $count == 0;
        if ($this->hasAny($params)) {
